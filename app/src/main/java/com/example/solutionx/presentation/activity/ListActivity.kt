...
import com.example.solutionx.presentation.adapter.OnListItemClick
...
class ListActivity : AppCompatActivity(), OnListItemClick {
    ...
    private fun setupRecyclerViews() {
        binding.recyclerSingleSelection.apply {
            ...
            customAdapter.setItems(com.example.solutionx.domain.model.DataModel.getCountries(this@ListActivity))
        }
    }
