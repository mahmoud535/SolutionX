...
class Logger(private val clazz: Class<*>) {
    ...
    get() = com.example.solutionx.features.services.presentation.productflavors.helpers.logging.LoggerFactory.currentDebugLogWriter.isDebugEnabled

    fun debug(message: String?) {
        com.example.solutionx.features.services.presentation.productflavors.helpers.logging.LoggerFactory.currentDebugLogWriter.isDebugEnabled
    }
