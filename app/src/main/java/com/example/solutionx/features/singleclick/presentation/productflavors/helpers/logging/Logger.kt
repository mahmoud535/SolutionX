package com.example.solutionx.features.singleclick.presentation.productflavors.helpers.logging
...
class Logger(private val clazz: Class<*>) {
    ...
    val isDebugEnabled: Boolean
        get() = LoggerFactory.currentDebugLogWriter.isDebugEnabled

    fun debug(message: String?) {
        LoggerFactory.currentDebugLogWriter.debug(clazz, message)
    }
